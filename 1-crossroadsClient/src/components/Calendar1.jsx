...
const Calendar = () => {
  return (
    <>
      <section className='relative  bg-base-300 py-5  my-28'>
              ...
              <tbody>
                <DayRow>
                  <Day
                    number=''
                    // eventTitle1='SOUTH'
                    // eventTitle2='Florida, Georgia'
                    // eventTitle3='North Carolina,'
                    // eventTitle4='Tennessee, Louisiana ,'
                    // eventTitle5='Texas'
                    // eventDate='8AM - 6PM'
                  />
                  <Day number='' />
                ...
                <DayRow>
                  ...
                  <Day
                    ...
                    eventTitle2='Missouri, Illinois'
                    eventTitle3='Nebraska, Minnesota'
                    eventTitle4='Indiana, Missouri, Ohio'
                    eventTitle5='Wisconsin, Kentucky'
                    eventDate='4PM - 8PM'
                  />
                  <Day
      ...
      <div className='mx-auto flex h-24 w-10 flex-col overflow-hidden sm:w-full md:h-40 md:w-20 lg:w-28 2xl:w-40 '>
        ...
        {active && (
          <div className='bottom md:h-30 group h-16 w-full flex-grow cursor-pointer py-1'>
            ...
            <div className='event invisible absolute left-2 z-2 mb-1 w-[200%] rounded border-l-[3px] border-primary bg-gray-2 px-2 py-[6px] text-left opacity-0 group-hover:visible group-hover:opacity-100 dark:bg-dark md:visible md:w-[190%] lg:opacity-100 text-[8px] lg:text-sm'>
