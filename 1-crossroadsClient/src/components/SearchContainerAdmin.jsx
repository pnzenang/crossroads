...
import { useAllPackagesAdminContext } from '../pages/AllPackagesAdmin.jsx';

const SearchContainerAdmin = () => {
  const { searchValues } = useAllPackagesAdminContext();
  const {
    search,
    packageState,
    destinationCountry,
    ...
    <section className='  place-items-center mt-20  '>
      ...
      >
        ...
        <div className='  grid lg:grid-cols-2 2xl:grid-cols-3 gap-4  '>
          ...
          />
          <Link
            to='/dashboard/all-packages-admin'
...
export default SearchContainerAdmin;
