...
const Testimonial4 = () => {
  ...
  useEffect(() => {
    const typedJS = new Typed(typedJSRef.current, {
      strings: [' to our SAGI', ' to our Solidarity', ' to our culture'],
      typeSpeed: 90,
      backSpeed: 90,
      backDelay: 200,
      startDelay: 500,
  ...
  return (
    <>
      <section className='pb-10 pt-20 dark:bg-red-300 lg:pb-20 lg:pt-[120px]'>
        <div className='container align-element '>
          <div className='-mx-4 flex flex-wrap justify-center'>
            <div className='w- px-4 '>
              <div className='mx-auto mb-[60px] ml-32 text-start'>
                <h1 className='mb-3 text-5xl font-bold leading-[1.2] text-base-content sm:text-7xl md:text-7xl'>
                  Welcome <span ref={typedJSRef} />
                </h1>
