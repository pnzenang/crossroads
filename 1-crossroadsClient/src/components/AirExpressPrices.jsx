...
const Accordion = () => {
  return (
    <section className='relative z-1 overflow-hidden bg-base-300 pb-6 pt-10 mb-10 lg:py-5 rounded-lg'>
      <div className='container mx-auto'>
        <div className='-mx-4 flex flex-wrap'>
          <div className='w-full px-4'>
            <div className='mx-auto mb-[60px] max-w-[520px] text-center lg:mb-20'>
              <h2 className='mb-4 text-2xl font-extrabold t md:text-5xl text-blue-400'>
                AIR EXPRESS PRICES
              </h2>
            </div>
          </div>
