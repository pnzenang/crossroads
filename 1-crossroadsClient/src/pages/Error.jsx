...
const Error = () => {
  ...
  if (error.status === 404) {
    return (
      <section className='relative z-1 flex min-h-screen items-center justify-center overflow-hidden bg-base-100 py-10 '>
        <div className='container mx-auto'>
          <div className='mx-auto w-full max-w-[570px] text-center'>
            <span className='text-[100px] font-extrabold text-primary sm:text-[160px]'>
              404
            </span>
            <h2 className='mb-3 text-2xl font-bold text-base-content sm:text-4xl'>
              Sorry, there is a problem.
            </h2>
            <p className='mx-auto mb-8 max-w-[490px] text-base-content'>
              We can't seem to find the page you are looking for.
            </p>

            <Link
              to='/'
              className='rounded-lg bg-secondary px-8 py-3 text-base font-medium text-white hover:bg-opacity-90'
            >
              Back to homepage
            </Link>
          </div>
